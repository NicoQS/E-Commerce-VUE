...
<template>
    ...
    <div class="bg-gradient-to-b from-gray-200 to-white">
            <FormSection class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8" @submitted="agregarProducto">
                <template #title>
                    <h2 class="font-semibold text-xl text-gray-600">Agregar Producto</h2>
                </template>

                <template #description>
                    <p class="text-gray-500 mb-6">LLene todos los campos del producto</p>
                </template>
