                        ...
                        <div class="max-w-xl mx-auto">
                            <div class="text-center ">
                                <div class="relative flex flex-col items-center">
                                    <h1 class="text-5xl font-bold text-blue-500"> Nuestro <span class="text-blue-500"> Contacto
                                        </span> </h1>
                            ...
                            <form action="">
                                <div class="mb-6">
                                    <h2 class="text-xl font-bold text-gray-00 dark:text-gray-400">
                                        ¡Por favor envíe un mensaje para obtener más información! </h2>
                                </div>
                                ...
                                <textarea rows="4" type="message" placeholder="Escribe un mensaje..."
